...
<html lang="pt-br">
    ...
    <head>
        ...
        <link rel="stylesheet" href="css/style_paciente.css">
    ...
    <body>
        ...
        <div class="container_pesquisa">
            <input class="input_pesquisa" type="text" id="nome" placeholder="Pesquisar paciente">
            <a href="cadastro_paciente.php"><button class="button_pesquisa" type="submit"> + Add Paciente </button></a>
        </div>
